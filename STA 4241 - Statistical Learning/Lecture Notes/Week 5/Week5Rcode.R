...
for (ni in 1 : nSim) {
  ...
  trainErrorMat[ni,1] = mean(trainPred != (as.numeric(SmarketTrain$Direction) - 1))
  ...
  trainPredSVM = 1*(as.character(fit$fitted) == "Up")
  
  errorMat[ni,2] = mean(predSVM != (as.numeric(SmarketTest$Direction) - 1))
  trainErrorMat[ni,2] = mean(trainPredSVM != (as.numeric(SmarketTrain$Direction) - 1))
  ...
  errorMat[ni,3] = mean(predSVM != (as.numeric(SmarketTest$Direction) - 1))
  trainErrorMat[ni,3] = mean(trainPredSVM != (as.numeric(SmarketTrain$Direction) - 1))
  ...
  errorMat[ni,4] = mean(predSVM != (as.numeric(SmarketTest$Direction) - 1))
  trainErrorMat[ni,4] = mean(trainPredSVM != (as.numeric(SmarketTrain$Direction) - 1))
  ...
  errorMat[ni,5] = mean(predSVM != (as.numeric(SmarketTest$Direction) - 1))
  trainErrorMat[ni,5] = mean(trainPredSVM != (as.numeric(SmarketTrain$Direction) - 1))
}
