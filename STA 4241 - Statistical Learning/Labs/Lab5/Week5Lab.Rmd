...
data_gamma
ggplot(data = data_test_gamma) + geom_point() + aes(x = x, y = y)
...
data_test_var
ggplot(data = data_test_var) + geom_point() + aes(x = x, y = y)
